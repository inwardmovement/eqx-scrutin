          ...
          <div className="grid w-full items-center gap-4">
            <div className="flex flex-col space-y-2">
              ...
              <div className="flex items-center justify-center w-full">
                <label
                  htmlFor="document"
                  className={`flex flex-col items-center justify-center w-full border-2 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 ${isLoading ? "opacity-50 pointer-events-none" : ""}`}
                >
                  <div className="flex flex-col items-center justify-center p-5">
                    {isLoading ? (
                      ...
                      <>
                        ...
                        <p className="mb-2 text-sm text-gray-500 dark:text-gray-400 text-center">Téléversez un fichier CSV au format suivant
                        </p>
